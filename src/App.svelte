...
<main>
    ...
    <div class="form">
        <div>
            ...
            <input bind:checked={currentValue.feminine} name="feminine" type="checkbox" />
        </div>
        <br />
        <button
            on:click={() => {
            ...
            >
                <tbody>
                    <td width="140px" align="center">
                        <a href="http://www.telecom-etude.fr/" rel="noopener" target="_blank">
                            <img
                                width="100"
                                height="100"
                    ...
                    <td>
                        ...
                        <a href="https://www.telecom-paris.fr/" style="color: #E54540" target="_blank">Télécom Paris</a
                        ><br />

                        {currentValue.poste} à
                        <a href="http://www.telecom-etude.fr/" style="color: #E54540" target="_blank">Telecom Etude</a
                        ><br />
	...
	<table
		...
		<tbody>
			...
			<td>
				...
				${currentValue.poste} à
				<a href="http://www.telecom-etude.fr/" style="color:#E54540" target="_blank">Telecom Etude</a><br />
				<a href="mailto:${currentValue.mail}" target="_blank" style="color:#E54540">
					${currentValue.mail}
				</a><br />
				<a style="color:#E54540" href="tel:${currentValue.phone}">
